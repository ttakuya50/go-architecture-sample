...
var TaskWhere = struct {
	...
	ListID:    whereHelperint64{field: "`task`.`list_id`"},
	UserID:    whereHelperint64{field: "`task`.`user_id`"},
	Title:     whereHelperstring{field: "`task`.`title`"},
	Memo:      whereHelpernull_String{field: "`task`.`memo`"},
	IsDone:    whereHelperbool{field: "`task`.`is_done`"},
...
var (
	taskAllColumns            = []string{"id", "list_id", "user_id", "title", "memo", "is_done", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"id", "list_id", "user_id", "title", "memo", "is_done", "created_at", "updated_at"}
...
func (q taskQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Task, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for task")
	}
...
func (q taskQuery) All(ctx context.Context, exec boil.ContextExecutor) (TaskSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to Task slice")
	}
...
func (q taskQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count task rows")
	}
...
func (q taskQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if task exists")
	}
...
func (o *Task) List(mods ...qm.QueryMod) listQuery {
	...
	query := Lists(queryMods...)
	queries.SetFrom(query.Query, "`list`")
...
func (taskL) LoadList(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	...
	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for list")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for list")
	}
...
func FindTask(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Task, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from task")
	}
...
func (o *Task) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no task provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into task")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for task")
	}
...
func (o *Task) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update task, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update task row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for task")
	}
...
func (q taskQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for task")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for task")
	}
...
func (o TaskSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in task slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all task")
	}
	return rowsAff, nil
}
...
func (o *Task) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no task provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert task, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for task")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for task")
	}
...
func (o *Task) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no Task provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from task")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for task")
	}
...
func (q taskQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no taskQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from task")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for task")
	}
...
func (o TaskSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from task slice")
	}
...
func (o *TaskSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in TaskSlice")
	}
...
func TaskExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if task exists")
	}
